...
SELECT HT1.organization_id, HT1.user_num, HT1.total_contract_created, 
HT1.total_contract_signed, HT1.transition_hours, HT2.user_id, HT2.primary_organization_id,
HT2.joined_num, HT2.total_created, HT2.total_signed, HT2.transition_hours FROM
(
SELECT * FROM
...
ON HT1.organization_id = HT2.primary_organization_id

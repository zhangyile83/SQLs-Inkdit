...
/* The total number of contracts created by all organization ID or all switchers */ /* Forth level sketch */
...
/* Count the total created and signed contracts by each group */ /* Fourth level sketch */
